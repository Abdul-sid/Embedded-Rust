...
//         // iprintln!(&mut itm.stim[0], "y: {}", y);
//         // iprintln!(&mut itm.stim[0], "z: {}", z);
//         // iprintln!(&mut itm.stim[0], "{:?}", "---------------------------");
...
// //         iprintln!(&mut itm.stim[0], "{:?}", "Magnetic reading");
// //         iprintln!(&mut itm.stim[0], "x: {}", x);
// //         iprintln!(&mut itm.stim[0], "y: {}", y);
// //         iprintln!(&mut itm.stim[0], "z: {}", z);
// //         iprintln!(&mut itm.stim[0], "{:?}", "---------------------------");
...
// //          iprintln!(&mut itm.stim[0], "accelerometer reading");
// //         iprintln!(&mut itm.stim[0], "x : {}", x);
// //         iprintln!(&mut itm.stim[0], "y : {}", y);
// //         iprintln!(&mut itm.stim[0], "z : {}", z);
// //         iprintln!(&mut itm.stim[0], "{:?}", "---------------------------");
...
//accelerometer
        ...
        if z <= 0.0 {
            iprintln!(&mut itm.stim[0], "face is down");
        }
        else if z > 0.0 {
            iprintln!(&mut itm.stim[0], "face is up");
        }
        else if z == 0.0 {
            iprintln!(&mut itm.stim[0], "leveled");
        }
